      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : HomePageWidget(
                  searchLimit: params.getParam('searchLimit', ParamType.int),
                ),
        ),
        FFRoute(
          name: 'CartPage',
          ...
          builder: (context, params) => params.isEmpty
              ...
              : CartPageWidget(
                  ...
                  tax: params.getParam('tax', ParamType.double),
                ),
        ),
        FFRoute(
          name: 'AccountPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => PaymentPageWidget(
            finalPrice: params.getParam('finalPrice', ParamType.double),
          ),
        ),
        FFRoute(
          name: 'StorePage2',
          path: '/storePage2',
          builder: (context, params) => StorePage2Widget(),
        )
